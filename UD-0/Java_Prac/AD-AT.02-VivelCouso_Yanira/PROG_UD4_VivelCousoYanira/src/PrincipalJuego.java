...
public class PrincipalJuego {
  public static void main(String[] args) {
    ...
    System.out.println("Inserte nivel de peligro (debe ser un número entero): ");
    ...
    // Comparator
    System.out.println();
    System.out.println("Orden por vida:");
    personajes.add(mago);
    personajes.add(monstruo);
    
    Comparador comparamos = new Comparador();
    personajes.sort(comparamos);
