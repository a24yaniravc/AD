...
public class Principal {
    ...
    // Variables
    private static PostgreSQL_Connection PostgreSQL_connection;
    ...
    public static void main(String[] args) {
        ...
        PostgreSQL_connection = new PostgreSQL_Connection();

        if (PostgreSQL_connection.getConnectionServer() != null) {
        ...
        // Usamos la DB dam2
        conn = PostgreSQL_connection.getConnection();
